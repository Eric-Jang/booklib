...
public class RemarkController {
	...
	public String add(final Invocation inv, final Remark remark) {
		...
		return "r:" + Utils.path(inv) + "/book/" + remark.getBookId();
	}
	...
	@Post("deleteAll")
	@AdminRequired
	public String clear(final Invocation inv, @Param("bookId") final long bookId) {
		this.remarkDAO.deleteByBook(bookId);
		return "r:" + Utils.path(inv) + "/book/" + bookId;
	}
	...
	public String delete(final Invocation inv,
		...
		return "r:" + Utils.path(inv) + "/book/" + bookId + "?pageIndex="
				+ pageIndex;
	}
}
